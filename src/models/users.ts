...
export const getUserBySessionToken = (sessionToken: string) => // find a user by his session token
  UserModel.findOne({
...
export const createUser = (values: Record<string, any>) => // create a new user
  new UserModel(values).save().then((user) => user.toObject());

export const deleteUserById = (id: string) => // delete a user by his ID
  UserModel.findOneAndDelete({ _id: id });

export const updateUserById = (id: string, values: Record<string, any>) => // update a user by his ID
